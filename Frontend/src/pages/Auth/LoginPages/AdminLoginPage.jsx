...
import { Shield, Lock, Mail, Eye, EyeOff } from 'lucide-react'; // Added Eye and EyeOff icons
...
const AdminLoginPage = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (formData.email === 'admin@example.com' && formData.password === 'adminpass') {
      ...
      // In a real app, you would redirect the admin to their dashboard
    } else {
    ...
    <div className=" pt-14 min-h-screen bg-gradient-to-br from-orange-100 to-pink-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Welcome, Admin! Please sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="remember-me-admin" className="ml-2 block text-sm text-gray-700">
                Remember me
              </label>
            </div>
