...
const UserRegisterPage = () => {
  ...
  const handleRegister = (e) => {
    ...
    // You might want to redirect to login page or dashboard after successful registration
  };

  return (
    <>
      <LoginNavbar/>
      <div className="pt-23 min-h-screen bg-gradient-to-br from-orange-100 to-pink-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <a onClick={() => navigate('/login')} className="text-orange-500 hover:text-orange-600 font-semibold cursor-pointer">
                Sign In
              </a>
              <span className="mx-2 text-gray-400">|</span>
              <a onClick={() => navigate('/developerregister')} className="text-orange-500 hover:text-orange-600 font-semibold cursor-pointer">
